...
export function Logo ({ width, height }){
  ...
  svg {
    width: ${({ propdwidth }) => (typeof width === 'number' ? `${width}px` : '70px')};
    height: ${({ propsheight }) => (typeof height === 'number' ? `${height}px` : '70px')};
    stroke: white;
  }
...
<svg
        ...
        fill="white"
      >
 <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" fill='white'> 
    <motion.path
  ...
  <motion.path
      ...
      initial="hidden"
      animate="visible" d="M2020 1778 c65 -9 168 -31 205 -43 19 -6 19 -6 1 9 -26 21 -144 46 -213 45 l-58 -2 65 -9z"/> 
         <motion.path
      
      initial="hidden"
      animate="visible" d="M1990 1721 c0 -4 31 -13 69 -19 38 -7 90 -21 116 -32 60 -26 71 -19 16 9 -52 27 -201 58 -201 42z"/>
          <motion.path
    
      initial="hidden"
      animate="visible" d="M1710 1711 l-45 -6 -6 -140 c-3 -77 -10 -197 -14 -267 l-7 -128 31 0 c17 0 31 4 31 9 0 5 -9 7 -21 4 -21 -6 -21 -5 -14 168 4 96 10 212 14 259 l6 85 55 3 c30 2 59 8 65 13 10 10 -21 10 -95 0z"/>
           <motion.path
  
      initial="hidden"
      animate="visible"d="M2360 1656 c0 -4 15 -29 34 -56 40 -58 73 -140 88 -220 6 -30 15 -60 19 -66 12 -15 87 -2 162 27 42 16 61 19 69 11 25 -25 -88 -83 -229 -118 -7 -2 -13 -13 -13 -24 0 -45 -33 -179 -62 -247 -111 -268 -415 -495 -747 -559 -82 -16 -101 -24 -54 -24 98 0 343 93 463 175 30 21 60 38 67 38 7 0 10 4 8 8 -6 8 67 65 78 61 5 -1 6 1 3 6 -7 12 78 94 89 85 4 -5 5 -3 2 4 -4 6 9 35 29 65 58 84 100 185 124 293 11 54 22 100 23 100 1 1 38 14 82 29 131 45 183 91 142 124 -9 8 -36 3 -100 -19 -122 -42 -128 -40 -144 45 -12 68 -61 186 -90 218 -8 9 -12 22 -7 30 4 7 4 10 -1 6 -4 -4 -14 -3 -22 3 -7 6 -13 9 -13 5z"/>
            <motion.path
      
      initial="hidden"
      animate="visible" d="M2357 1448 c12 -44 23 -98 23 -119 0 -37 -1 -39 -32 -39 -18 0 -40 -5 -48 -10 -21 -14 40 -13 76 0 25 10 26 13 20 63 -7 56 -43 174 -55 181 -4 3 3 -31 16 -76z"/> 
         <motion.path
 
      initial="hidden"
      animate="visible" d="M2053 1251 c-68 -11 -64 -24 5 -17 77 9 127 25 72 24 -19 0 -54 -4 -77 -7z"/> 
       <motion.path
     
      initial="hidden"
      animate="visible" d="M1840 1210 c-12 -8 -11 -10 8 -10 12 0 22 5 22 10 0 13 -11 13 -30 0z"/>
          <motion.path
   
      initial="hidden"
      animate="visible"d="M2302 1213 c-53 -7 -27 -21 29 -15 l51 5 -7 -44 c-23 -148 -83 -269 -202 -405 l-86 -99 73 70 c136 131 209 274 234 458 5 36 4 37 -27 35 -18 0 -47 -3 -65 -5z"/> 
          <motion.path
      
      initial="hidden"
      animate="visible" d="M2063 1178 c-29 -5 -53 -14 -53 -20 0 -6 10 -8 23 -5 12 4 41 9 65 13 23 4 42 10 42 15 0 10 -6 10 -77 -3z"/>
          <motion.path
   
      initial="hidden"
      animate="visible"d="M1825 1130 c-8 -13 25 -13 45 0 12 8 9 10 -12 10 -15 0 -30 -4 -33 -10z"/>
         <motion.path
      
      initial="hidden"
      animate="visible" d="M1642 1098 c-7 -7 -12 -22 -12 -34 0 -50 -56 -58 -78 -11 -14 29 -12 29 -106 5 -56 -14 -36 -22 24 -9 66 14 70 14 70 -4 0 -8 12 -22 26 -31 24 -16 27 -16 52 3 15 11 28 32 30 46 2 15 10 27 17 27 8 0 17 5 20 10 9 14 -29 12 -43 -2z"/> 
        <motion.path
   
      initial="hidden"
      animate="visible"d="M1205 1065 c-303 -104 -453 -273 -376 -423 26 -49 104 -123 169 -160 33 -18 49 -32 40 -35 -7 -3 -4 -5 7 -4 11 1 59 -11 108 -27 48 -15 95 -26 105 -23 10 2 -2 9 -28 16 -268 71 -430 210 -404 346 9 49 58 120 113 161 56 43 181 105 274 135 37 12 67 26 67 30 0 5 -1 9 -2 8 -2 0 -34 -11 -73 -24z"/>
           <motion.path
     
      initial="hidden"
      animate="visible" d="M1210 986 c-152 -64 -252 -133 -286 -197 -35 -68 6 -162 98 -225 60 -41 193 -96 221 -92 14 2 -3 11 -48 26 -87 29 -171 74 -167 91 1 7 -2 10 -8 6 -14 -9 -37 11 -66 57 -25 39 -31 89 -15 131 22 56 127 128 274 187 31 12 60 26 63 31 8 14 -6 10 -66 -15z"/>
           <motion.path
      
      initial="hidden"
      animate="visible" d="M1098 553 c7 -3 16 -2 19 1 4 3 -2 6 -13 5 -11 0 -14 -3 -6 -6z"/> 
         <motion.path
      
      initial="hidden"
      animate="visible" d="M1399 449 c-9 -6 4 -9 40 -9 30 0 52 2 50 4 -11 9 -77 13 -90 5z"/> 
      <motion.path
      
      initial="hidden"
      animate="visible" d="M1413 373 c9 -2 25 -2 35 0 9 3 1 5 -18 5 -19 0 -27 -2 -17 -5z"/> 
  </g>
</svg>
</Container>
</>
